...
<html>
  ...
  <link rel="stylesheet" href="assets/css/index.min.css" />s
  ...
  <body>
    ...
    <div class="header-box" data-am-sticky>
        ...
        <!--header end-->
 		  ...
 		  <form class="am-form am-form-horizontal" action="addJobCollec" method="post">
                <div class="am-form-group">
                  <label  class="am-u-sm-3 am-form-label">职位ID</label>
                  <div class="am-u-sm-9">
                    <input type="text" id="jobId" name="jobId" placeholder="请输入用户ID">
                  ...
                  <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                      <input type="text" id="userId" name="userId" placeholder="文章ID">
