...
<html>
  ...
  <%
         ...
         ArticalCollection art = biz.findArtCollByID(collectionID);
        ...
        <div class="card-box">
          ...
          <div class="am-g tpl-amazeui-form">
            ...
            <div class="am-u-sm-12 am-u-md-9">
              <form class="am-form am-form-horizontal" action="updateArtiColl" method="post">
                 <input type="hidden" name=collectionId value="<%=art.getCollectionId()%>">
                <div class="am-form-group">
                  <label  class="am-u-sm-3 am-form-label">用户ID</label>
                  <div class="am-u-sm-9">
                    <input type="text" id="userId" name="userId" value="<%= art.getUserId()%>">
                  </div>
                </div>
                <div class="am-form-group">
                  <label  class="am-u-sm-3 am-form-label">文章ID</label>
                  <div class="am-u-sm-9">
                    <input type="text" id="articalId" name="articalId" value="<%=art.getArticalId()%>" >
