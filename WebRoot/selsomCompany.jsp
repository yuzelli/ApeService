              ...
              <table class="am-table am-table-striped am-table-hover table-main">
                ...
                <tbody>
                  <tr>
                   ...
                   <td>${company.companyHeadImg }</td>
                   <td>${company.companyName }</td>
                   <td>${company.companyAddress }</td>
                   <td>${company.companyIntroduce }</td>
                   <td>${company.companyScale }</td>
                 
                
                   
                     
                    <td>  <a href="changeCompany.jsp?companyId=${company.companyId  }">编辑</a> 
                    <a onclick="return confirm('您确定要删除？')" href="delCompany?companyId=${company.companyId  }">删除</a> 
                    </td>
                </tr>
                </tbody>
              </table>
