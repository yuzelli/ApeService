...
<html>
  ...
  <body>
   <%
         ...
         CompanyResume resume = biz.findCompanyResumeleByID(resumeID);
          ...
          <div class="am-g tpl-amazeui-form">
            ...
            <div class="am-u-sm-12 am-u-md-9">
              <form class="am-form am-form-horizontal" action="" method="post">
                 <input type="hidden" name="resumeID" value="<%= resume.getResume_id()%>">
                <div class="am-form-group">
                  <label  class="am-u-sm-3 am-form-label">用户ID</label>
                  <div class="am-u-sm-9">
                    <input type="text" id="userId" name="userId" value="<%= resume.getUserId()%>">
                  </div>
                </div>
                <div class="am-form-group">
                  <label  class="am-u-sm-3 am-form-label">职位ID</label>
                  <div class="am-u-sm-9">
                    <input type="text" id="jobId" name="jobId" value="<%= resume.getJobId()%>" >
                 ...
                 <div class="am-form-group">
                  ...
                  <div class="am-u-sm-9">
                    <input type="text" id="companyId" name="companyId" value="<%=resume.getCompanyId() %>" >
