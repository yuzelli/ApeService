...
public class updateJobColl extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public updateJobColl() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		jobCollection.setCollectionId(collectionJobID);
		jobCollection.setJobId(jobId);
		jobCollection.setUserId(userId);
		JobCollectionBiz biz = new JobCollectionBizImpl();
		try {
			biz.updateJobColl(jobCollection);
			response.sendRedirect("searchAllJobColl.jsp");
		} catch (Exception e) {
