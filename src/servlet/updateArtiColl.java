...
public class updateArtiColl extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public updateArtiColl() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		articalCollection.setCollectionId(collectionId);
		articalCollection.setUserId(userId);
		articalCollection.setArticalId(articalId);
		
		ArtCollectionBiz biz =new  ArtCollectionBizImpl();
		try {
			biz.updateArtColl(articalCollection);
			response.sendRedirect("searchAllArtiColl.jsp");
		} catch (Exception e) {
