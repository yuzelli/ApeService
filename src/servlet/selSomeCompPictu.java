...
public class selSomeCompPictu extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public selSomeCompPictu() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			CompanyPictures companyPictures =biz.findPicByID(pictureId);
			request.setAttribute("companyPictures", companyPictures);
			request.getRequestDispatcher("/selSomeCompPictu.jsp").forward(request, response);
		} catch (Exception e) {
