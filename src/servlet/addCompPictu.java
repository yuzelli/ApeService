...
public class addCompPictu extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		CompanyPictures companyPictures = new CompanyPictures();
		companyPictures.setCompanyId(companyId);
		companyPictures.setPictureURL(pictureUrl);
		CompanyPicBiz biz = new CompanyPicBizImpl();
		try {
			biz.addPic(companyPictures);
